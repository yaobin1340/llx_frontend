...
angular
    .module( 'ohapp' )
    .controller( 'descriptionsCrtl', function descriptionsCrtl( $scope, $injector, $rootScope,$stateParams) {
        var $http = $injector.get( '$http' );
        var $location = $injector.get('$location');
        var $state = $injector.get( '$state' );
        var $timeout = $injector.get( '$timeout' );
    ...
    .controller( 'preCodeCtrl', function preCodeCtrl( $scope, $injector, $rootScope,$stateParams) {
        ...
        if(!GetRequest().code){
                ...
                $http({
                    ...
                    location.href = 'http://llx.51loveshow.com/descriptions?shop_id='+$stateParams.shop_id+'&openid='+data.openid+'&type=1'+'&image_url='+$stateParams.image_url;
